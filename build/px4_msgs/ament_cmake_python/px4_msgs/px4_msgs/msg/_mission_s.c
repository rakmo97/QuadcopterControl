...
bool px4_msgs__msg__mission__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // mission_update_counter
    ...
    assert(PyLong_Check(field));
    ros_message->mission_update_counter = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // geofence_update_counter
    ...
    assert(PyLong_Check(field));
    ros_message->geofence_update_counter = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // safe_points_update_counter
    PyObject * field = PyObject_GetAttrString(_pymsg, "safe_points_update_counter");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->safe_points_update_counter = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject * px4_msgs__msg__mission__convert_to_py(void * raw_ros_message)
{
  ...
  {  // mission_update_counter
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->mission_update_counter);
    {
  ...
  {  // geofence_update_counter
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->geofence_update_counter);
    {
  ...
  {  // safe_points_update_counter
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->safe_points_update_counter);
    {
      int rc = PyObject_SetAttrString(_pymessage, "safe_points_update_counter", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
