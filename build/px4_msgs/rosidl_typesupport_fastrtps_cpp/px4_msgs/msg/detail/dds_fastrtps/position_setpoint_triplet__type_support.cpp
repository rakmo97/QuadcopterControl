...
#include "px4_msgs/msg/detail/position_setpoint_triplet__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_msgs::msg::PositionSetpointTriplet & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs::msg::PositionSetpointTriplet & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  // Member: previous
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        px4_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_PositionSetpoint(
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::PositionSetpointTriplet *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::PositionSetpointTriplet *>(
    untyped_ros_message);
...
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_PositionSetpointTriplet__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, PositionSetpointTriplet)() {
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_PositionSetpointTriplet__handle;
}
