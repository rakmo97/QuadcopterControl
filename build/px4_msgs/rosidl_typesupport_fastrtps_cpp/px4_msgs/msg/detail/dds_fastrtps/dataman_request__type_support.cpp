...
#include "px4_msgs/msg/detail/dataman_request__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_msgs::msg::DatamanRequest & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs::msg::DatamanRequest & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::DatamanRequest *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::DatamanRequest *>(
    untyped_ros_message);
...
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_DatamanRequest__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, DatamanRequest)() {
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_DatamanRequest__handle;
}
